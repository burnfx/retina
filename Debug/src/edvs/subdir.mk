...
src/edvs/%.o: ../src/edvs/%.c
	@echo 'Building file: $<'
	@echo 'Invoking: GCC C Compiler'
	gcc -DGXX_EXPERIMENTAL_CXX0X -I"/home/user/workspace/retina-git/LibOVR/Src" -I"/home/user/workspace/retina-git/LibOVR/Include" -O0 -g3 -Wall -c -fmessage-length=0 -MMD -MP -MF"$(@:%.o=%.d)" -MT"$(@:%.o=%.d)" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
